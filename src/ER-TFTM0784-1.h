...
//#define M12L2561616A
//#define W9825G6JH
//#define W9812G6JH // hangs the display - blank screen - doesn't exist
//#define W9812G6KH // this is originally selected
//#define MT48LC4M16A
//#define K4S641632N
//#define K4S281632K
...
class ER_TFTM0784 {
public:
    ER_TFTM0784(uint8_t rs_pin, uint8_t cs_pin, uint8_t wr_pin, uint8_t rd_pin, uint8_t next_pin, uint8_t d0_pin, uint8_t d1_pin, uint8_t d2_pin, uint8_t d3_pin, uint8_t d4_pin, uint8_t d5_pin, uint8_t d6_pin, uint8_t d7_pin, uint8_t d8_pin, uint8_t d9_pin, uint8_t d10_pin, uint8_t d11_pin, uint8_t d12_pin, uint8_t d13_pin, uint8_t d14_pin, uint8_t d15_pin, uint8_t rst_pin); // 16-bit parallel mode
    ER_TFTM0784(uint32_t spi_speed, uint8_t sdi_pin, uint8_t sdo_pin, uint8_t sclk_pin, uint8_t cs_pin, uint8_t rst_pin); // 4-pin SPI mode
    ...
    void RA8876_initial();
    //Set PLL
    void RA8876_PLL_Initial();
    //Set SDRAM
    void RA8876_SDRAM_initial();
    
    void Backlight_ON();
    void Backlight_OFF();
    
    //**Staus**//
    void Check_Mem_WR_FIFO_not_Full();
    void Check_Mem_WR_FIFO_Empty();
    void Check_Mem_RD_FIFO_not_Full();
    void Check_Mem_RD_FIFO_not_Empty();
    void Check_2D_Busy();
    void Check_SDRAM_Ready();
    uint8_t Power_Saving_Status();
    void Check_Power_is_Normal();//�O Normal mode �N���}
    void Check_Power_is_Saving();//�O Saving mode �N���}
    void Check_NO_Interrupt();//�S�� Interrupt �N���}
    void Check_Interrupt_Occur();//�� Interrupt �N���}
    
    void Check_Busy_Draw();
    void Check_Busy_SFI_DMA();
    
    //**[00h]**//
    void RA8876_SW_Reset();
    //**[01h]**//
    void Enable_PLL();
    void RA8876_Sleep();
    void RA8876_WakeUp();
    ...
    void Key_Scan_Disable();
    void RA8876_I2CM_Enable();
    void RA8876_I2CM_Disable();
    void Enable_SFlash_SPI();
    ...
    void RGB_16b_8bpp();
    void RGB_16b_16bpp();
    void RGB_16b_24bpp_mode1();
    void RGB_16b_24bpp_mode2();
    
    void MemRead_Left_Right_Top_Down();
    void MemRead_Right_Left_Top_Down();
    void MemRead_Top_Down_Left_Right();
    void MemRead_Down_Top_Left_Right();
    
    void MemWrite_Left_Right_Top_Down();
    void MemWrite_Right_Left_Top_Down();
    void MemWrite_Top_Down_Left_Right();
    void MemWrite_Down_Top_Left_Right();
    //**[03h]**//
    void Interrupt_Active_Low();
    void Interrupt_Active_High();
    void ExtInterrupt_Debounce();
    void ExtInterrupt_Nodebounce();
    void ExtInterrupt_Input_Low_Level_Trigger();
    void ExtInterrupt_Input_High_Level_Trigger();
    void ExtInterrupt_Input_Falling_Edge_Trigger();
    void ExtInterrupt_Input_Rising_Edge_Trigger();
    void LVDS_Format1();
    void LVDS_Format2();
    ...
    //**[0Ah]**//
    //**[0Bh]**//
    void Enable_Resume_Interrupt();
    void Disable_Resume_Interrupt();
    void Enable_ExtInterrupt_Input();
    void Disable_ExtInterrupt_Input();
    void Enable_I2CM_Interrupt();
    void Disable_I2CM_Interrupt();
    void Enable_Vsync_Interrupt();
    void Disable_Vsync_Interrupt();
    void Enable_KeyScan_Interrupt();
    void Disable_KeyScan_Interrupt();
    void Enable_DMA_Draw_BTE_Interrupt();
    void Disable_DMA_Draw_BTE_Interrupt();
    void Enable_PWM1_Interrupt();
    void Disable_PWM1_Interrupt();
    void Enable_PWM0_Interrupt();
    void Disable_PWM0_Interrupt();
    //**[0Ch]**//
    uint8_t Read_Interrupt_status();
    void Clear_Resume_Interrupt_Flag();
    void Clear_ExtInterrupt_Input_Flag();
    void Clear_I2CM_Interrupt_Flag();
    void Clear_Vsync_Interrupt_Flag();
    void Clear_KeyScan_Interrupt_Flag();
    void Clear_DMA_Draw_BTE_Interrupt_Flag();
    void Clear_PWM1_Interrupt_Flag();
    void Clear_PWM0_Interrupt_Flag();
    //**[0Dh]**//
    void Mask_Resume_Interrupt_Flag();
    void Mask_ExtInterrupt_Input_Flag();
    void Mask_I2CM_Interrupt_Flag();
    void Mask_Vsync_Interrupt_Flag();
    void Mask_KeyScan_Interrupt_Flag();
    void Mask_DMA_Draw_BTE_Interrupt_Flag();
    void Mask_PWM1_Interrupt_Flag();
    void Mask_PWM0_Interrupt_Flag();
    //
    void Enable_Resume_Interrupt_Flag();
    void Enable_ExtInterrupt_Input_Flag();
    void Enable_I2CM_Interrupt_Flag();
    void Enable_Vsync_Interrupt_Flag();
    void Enable_KeyScan_Interrupt_Flag();
    void Enable_DMA_Draw_BTE_Interrupt_Flag();
    void Enable_PWM1_Interrupt_Flag();
    void Enable_PWM0_Interrupt_Flag();
    //**[0Eh]**//
    void Enable_GPIOF_PullUp();
    void Enable_GPIOE_PullUp();
    void Enable_GPIOD_PullUp();
    void Enable_GPIOC_PullUp();
    void Enable_XDB15_8_PullUp();
    void Enable_XDB7_0_PullUp();
    void Disable_GPIOF_PullUp();
    void Disable_GPIOE_PullUp();
    void Disable_GPIOD_PullUp();
    void Disable_GPIOC_PullUp();
    void Disable_XDB15_8_PullUp();
    void Disable_XDB7_0_PullUp();
    
    //**[0Fh]**//
    void XPDAT18_Set_GPIO_D7();
    void XPDAT18_Set_KOUT4();
    void XPDAT17_Set_GPIO_D5();
    void XPDAT17_Set_KOUT2();
    void XPDAT16_Set_GPIO_D4();
    void XPDAT16_Set_KOUT1();
    void XPDAT9_Set_GPIO_D3();
    void XPDAT9_Set_KOUT3();
    void XPDAT8_Set_GPIO_D2();
    void XPDAT8_Set_KIN3();
    void XPDAT2_Set_GPIO_D6();
    void XPDAT2_Set_KIN4();
    void XPDAT1_Set_GPIO_D1();
    void XPDAT1_Set_KIN2();
    void XPDAT0_Set_GPIO_D0();
    void XPDAT0_Set_KIN1();
    ...
    void Select_Main_Window_8bpp();
    void Select_Main_Window_16bpp();
    void Select_Main_Window_24bpp();
    //**[11h]**//
    void Select_PIP1_Window_8bpp();
    void Select_PIP1_Window_16bpp();
    void Select_PIP1_Window_24bpp();
    void Select_PIP2_Window_8bpp();
    void Select_PIP2_Window_16bpp();
    void Select_PIP2_Window_24bpp();
    //**[12h]**//
    void PCLK_Rising();
    void PCLK_Falling();
    void Display_ON();
    ...
    void PDATA_Set_BRG();
    void PDATA_Set_BGR();
    void PDATA_IDLE_STATE();
    
    //**[13h]**//
    void HSYNC_Low_Active();
    void HSYNC_High_Active();
    void VSYNC_Low_Active();
    void VSYNC_High_Active();
    void DE_Low_Active();
    void DE_High_Active();
    void Idle_DE_Low();
    void Idle_DE_High();
    ...
    void Idle_PDAT_High();
    void Idle_HSYNC_Low();
    void Idle_HSYNC_High();
    void Idle_VSYNC_Low();
    void Idle_VSYNC_High();
    //**[14h][15h][1Ah][1Bh]**//
    ...
    void Select_Graphic_Cursor_1();
    void Select_Graphic_Cursor_2();
    void Select_Graphic_Cursor_3();
    void Select_Graphic_Cursor_4();
    ...
    //**[5E]**//
    void Select_Write_Data_Position();
    void Select_Read_Data_Position();
    void Memory_XY_Mode();
    void Memory_Linear_Mode();
    void Memory_8bpp_Mode();
    void Memory_16bpp_Mode();
    void Memory_24bpp_Mode();
    //**[5Fh][60h][61h][62h]**//
    ...
    //**[76h]**//
    void Start_Circle_or_Ellipse();
    void Start_Circle_or_Ellipse_Fill();
    void Start_Left_Down_Curve();
    void Start_Left_Up_Curve();
    void Start_Right_Up_Curve();
    void Start_Right_Down_Curve();
    void Start_Left_Down_Curve_Fill();
    void Start_Left_Up_Curve_Fill();
    void Start_Right_Up_Curve_Fill();
    void Start_Right_Down_Curve_Fill();
    void Start_Square();
    void Start_Square_Fill();
    void Start_Circle_Square();
    void Start_Circle_Square_Fill();
    //**[77h]~[7Eh]**//
    ...
    //**[85h]**//
    void Select_PWM1_Clock_Divided_By_1();
    void Select_PWM1_Clock_Divided_By_2();
    void Select_PWM1_Clock_Divided_By_4();
    void Select_PWM1_Clock_Divided_By_8();
    void Select_PWM0_Clock_Divided_By_1();
    void Select_PWM0_Clock_Divided_By_2();
    void Select_PWM0_Clock_Divided_By_4();
    void Select_PWM0_Clock_Divided_By_8();
    //[85h].[bit3][bit2]
    void Select_PWM1_is_ErrorFlag();
    void Select_PWM1();
    void Select_PWM1_is_Osc_Clock();
    //[85h].[bit1][bit0]
    void Select_PWM0_is_GPIO_C7();
    void Select_PWM0();
    void Select_PWM0_is_Core_Clock();
    //**[86h]**//
    //[86h]PWM1
    void Enable_PWM1_Inverter();
    void Disable_PWM1_Inverter();
    void Auto_Reload_PWM1();
    void One_Shot_PWM1();
    void Start_PWM1();
    void Stop_PWM1();
    //[86h]PWM0
    void Enable_PWM0_Dead_Zone();
    void Disable_PWM0_Dead_Zone();
    void Enable_PWM0_Inverter();
    void Disable_PWM0_Inverter();
    void Auto_Reload_PWM0();
    void One_Shot_PWM0();
    void Start_PWM0();
    void Stop_PWM0();
    //**[87h]**//
    ...
    void Pattern_Format_8X8();
    void Pattern_Format_16X16();
    ...
    //[92h]=========================================================================
    void BTE_S0_Color_8bpp();
    void BTE_S0_Color_16bpp();
    void BTE_S0_Color_24bpp();
    
    void BTE_S1_Color_8bpp();
    void BTE_S1_Color_16bpp();
    void BTE_S1_Color_24bpp();
    void BTE_S1_Color_Constant();
    void BTE_S1_Color_8bit_Alpha();
    void BTE_S1_Color_16bit_Alpha();
    
    void BTE_Destination_Color_8bpp();
    void BTE_Destination_Color_16bpp();
    void BTE_Destination_Color_24bpp();
    ...
    void Select_SFI_0();
    void Select_SFI_1();
    void Select_SFI_Font_Mode();
    void Select_SFI_DMA_Mode();
    void Select_SFI_24bit_Address();
    void Select_SFI_32bit_Address();
    void Select_SFI_Waveform_Mode_0();
    void Select_SFI_Waveform_Mode_3();
    void Select_SFI_0_DummyRead();
    void Select_SFI_8_DummyRead();
    void Select_SFI_16_DummyRead();
    void Select_SFI_24_DummyRead();
    void Select_SFI_Single_Mode();
    void Select_SFI_Dual_Mode0();
    void Select_SFI_Dual_Mode1();
    
    //REG[B8h] SPI master Tx /Rx FIFO Data Register (SPIDR)
    uint8_t SPI_Master_FIFO_Data_Put(uint8_t Data);
    uint8_t SPI_Master_FIFO_Data_Get();
    
    //REG[B9h] SPI master Control Register (SPIMCR2)
    void Mask_SPI_Master_Interrupt_Flag();
    void Select_nSS_drive_on_xnsfcs0();
    void Select_nSS_drive_on_xnsfcs1();
    void nSS_Inactive();
    void nSS_Active();
    void OVFIRQEN_Enable();
    void EMTIRQEN_Enable();
    void Reset_CPOL();
    void Set_CPOL();
    void Reset_CPHA();
    void Set_CPHA();
    ...
    uint8_t Tx_FIFO_Empty_Flag();
    uint8_t Tx_FIFO_Full_Flag();
    uint8_t Rx_FIFO_Empty_Flag();
    uint8_t Rx_FIFO_full_flag();
    uint8_t OVFI_Flag();
    void Clear_OVFI_Flag();
    uint8_t EMTI_Flag();
    void Clear_EMTI_Flag();
    ...
    void Font_Select_UserDefine_Mode();
    void CGROM_Select_Internal_CGROM();
    void CGROM_Select_Genitop_FontROM();
    void Font_Select_8x16_16x16();
    void Font_Select_12x24_24x24();
    void Font_Select_16x32_32x32();
    void Internal_CGROM_Select_ISOIEC8859_1();
    void Internal_CGROM_Select_ISOIEC8859_2();
    void Internal_CGROM_Select_ISOIEC8859_3();
    void Internal_CGROM_Select_ISOIEC8859_4();
    //**[CDh]**//
    void Enable_Font_Alignment();
    void Disable_Font_Alignment();
    void Font_Background_select_Transparency();
    void Font_Background_select_Color();
    void Font_0_degree();
    void Font_90_degree();
    void Font_Width_X1();
    void Font_Width_X2();
    ...
    void Font_Height_X4();
    //**[CEh]**//
    void GTFont_Select_GT21L16TW_GT21H16T1W();
    void GTFont_Select_GT23L16U2W();
    void GTFont_Select_GT23L24T3Y_GT23H24T3Y();
    void GTFont_Select_GT23L24M1Z();
    void GTFont_Select_GT23L32S4W_GT23H32S4W();
    void GTFont_Select_GT20L24F6Y();
    void GTFont_Select_GT21L24S1W();
    ...
    //**[DFh]**//
    void Power_Normal_Mode();
    void Power_Saving_Standby_Mode();
    void Power_Saving_Suspend_Mode();
    void Power_Saving_Sleep_Mode();
    ...
    //**[E8h]**//
    uint8_t RA8876_I2CM_Receiver_Data();
    //**[E9h]**//
    
    void RA8876_I2CM_Read_With_Ack();
    void RA8876_I2CM_Read_With_Nack();
    void RA8876_I2CM_Write_With_Start();
    void RA8876_I2CM_Write();
    void RA8876_I2CM_Stop();
    
    
    //**[EAh]**//
    uint8_t RA8876_I2CM_Check_Slave_ACK();
    uint8_t RA8876_I2CM_Bus_Busy();
    uint8_t RA8876_I2CM_transmit_Progress();
    uint8_t RA8876_I2CM_Arbitration();
    ...
    uint8_t Numbers_of_Key_Hit();
    
    //[FDh][FEh][FFh]
    uint8_t Read_Key_Strobe_Data_0();
    uint8_t Read_Key_Strobe_Data_1();
    uint8_t Read_Key_Strobe_Data_2();
...
private:
    inline void bus_delay();
    void Enable_ExtInterrupt_Inpur_Flag();
    void Text_cursor_initial();
    void dataBusSetDirection8(uint8_t dir);
    void dataBusSetDirection16(uint8_t dir);
    uint8_t dataBusRead8();
    uint16_t dataBusRead16();
